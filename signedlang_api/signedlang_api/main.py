...
from models.translation import TextToSignResponse, TextToSignRequest
...
@app.post("/text-to-sign-video", response_model=TextToSignResponse)
async def post_text_to_sign_video(request: TextToSignRequest):
    return TextToSignResponse(videoUrl="https://")
